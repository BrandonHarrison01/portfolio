      ...
      <div className='modal-main'>
        ...
        <div className='modal-body'>
          <div>
            <img
              className={
                props.populateModal.title === "forLife Fitness"
                  ? "gif desktop"
                  : "gif"
              }
              src={props.populateModal.gif}
              alt='project gif'
            />
          </div>
          <div className='modal-desc'>
            ...
            <ul>
              {props.populateModal.features.map(bullet => (
                <li key={bullet.id}>{bullet.bullet}</li>
              ))}
            </ul>
            {props.populateModal.title === "Key Conservation" ? (
              <p>
                *App is currently in testing phase on Google Play and the App
                Store.
              </p>
            ) : (
              ""
